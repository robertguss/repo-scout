...
fn milestone94_orient_shows_all_sections() {
    ...
    assert!(output.contains("STRUCTURE"), "should have STRUCTURE section:\n{output}");
    assert!(output.contains("HEALTH"), "should have HEALTH section:\n{output}");
    assert!(output.contains("HOTSPOTS"), "should have HOTSPOTS section:\n{output}");
    assert!(output.contains("CIRCULAR"), "should have CIRCULAR section:\n{output}");
    assert!(output.contains("RECOMMENDATIONS"), "should have RECOMMENDATIONS section:\n{output}");
}
...
fn milestone94_orient_depth_respected() {
    ...
    assert!(output.contains("STRUCTURE"), "should have STRUCTURE:\n{output}");
...
fn milestone94_orient_json_contains_all_sections() {
    ...
    assert!(json["hotspots"].is_array(), "should have hotspots:\n{output}");
    assert!(json["circular"].is_object(), "should have circular:\n{output}");
    assert!(json["recommendations"].is_array(), "should have recommendations:\n{output}");
}
